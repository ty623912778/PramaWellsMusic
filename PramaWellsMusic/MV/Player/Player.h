...
// 播放完成
- (void)playerPlaybackDidEnd:(Player *)player;
/**
 *  播放状态发发生改变
 *
 *  @param player player
 *  @param state  播放状态
 */
- (void)player:(Player *)player playStateChanged:(PlayerPlaybackState)state;
/**
 *  监听屏幕方向的改变
 *
 *  @param player      player
 ...
 */
- (void)player:(Player *)player orientationChanged:(UIDeviceOrientation)orientation;
@end
