...
+ (instancetype)initilzerProgressViewWithFrame:(CGRect)frame {
    PlayerProgressView *progressView = [[PlayerProgressView alloc] initWithFrame:frame];
    ...
    [progressView setThumbImage:[UIImage imageNamed:VideoName(@"player-kit-slider_indicator")] forState:UIControlStateNormal];
    [progressView setMinimumTrackImage:[UIImage imageNamed:VideoName(@"player-kit-slider_track_fill")] forState:UIControlStateNormal];
    
    [progressView setMaximumTrackImage: [UIImage imageNamed:VideoName(@"player-kit-slider_track_empty")] forState:UIControlStateNormal];
    return progressView;
}
